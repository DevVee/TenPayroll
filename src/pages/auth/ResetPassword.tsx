    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--color-bg)' }}>
        <div className="text-center" style={{ maxWidth: 380 }}>
          <p style={{ fontSize: 18, fontWeight: 700, color: 'var(--color-text)', marginBottom: 8 }}>Link expired or invalid</p>
    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--color-bg)' }}>
      ...
      >
        <div className="flex items-center gap-2.5 mb-8">
          ...
          <p style={{ fontSize: 20, fontWeight: 800, color: 'var(--color-text)', letterSpacing: '-0.03em' }}>{brand.appName}</p>
        </div>
        ...
        <AnimatePresence mode="wait">
          {done ? (
            <motion.div key="done" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="text-center">
              ...
              <h2 style={{ fontSize: 22, fontWeight: 800, color: 'var(--color-text)', marginBottom: 8, letterSpacing: '-0.03em' }}>
                Password updated
              </h2>
              <p style={{ fontSize: 14, color: 'var(--color-text-muted)' }}>Redirecting you to sign in…</p>
            </motion.div>
          ) : (
            <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <div className="mb-8">
                <h2 style={{ fontSize: 26, fontWeight: 800, color: 'var(--color-text)', letterSpacing: '-0.04em', marginBottom: 6 }}>
                  Set new password
                </h2>
                <p style={{ fontSize: 14, color: 'var(--color-text-muted)' }}>Choose a strong password for your account.</p>
              </div>
